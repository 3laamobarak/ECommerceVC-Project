...
{
    /// <inheritdoc />
    public partial class withseeding : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2025, 5, 4, 18, 36, 33, 624, DateTimeKind.Local).AddTicks(1268), "3al@gmail.com", "Alaa", new DateTime(2025, 5, 4, 18, 36, 33, 626, DateTimeKind.Local).AddTicks(8907), "Mobarak", "asdasdasa", 2, "lolomomo" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, null, new DateTime(2025, 5, 4, 18, 36, 33, 627, DateTimeKind.Local).AddTicks(722), 0, 699.99m, 1 },
                    { 2, null, new DateTime(2025, 5, 4, 18, 36, 33, 627, DateTimeKind.Local).AddTicks(1417), 3, 19.99m, 1 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2025, 5, 4, 15, 36, 33, 627, DateTimeKind.Utc).AddTicks(3492), 1, 1, 1 },
                    { 2, new DateTime(2025, 5, 4, 15, 36, 33, 627, DateTimeKind.Utc).AddTicks(4277), 3, 2, 1 },
                    { 3, new DateTime(2025, 5, 4, 15, 36, 33, 627, DateTimeKind.Utc).AddTicks(4279), 4, 1, 1 }
                });
